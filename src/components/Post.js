                                                    ...
                                                    <div className="card-body pb-0">
                                                        <div className="card-header">
                                                            <div className="media flex-wrap w-100 align-items-center ">
                                                                ...
                                                                <div>
                                                                    <a href="#" style={{margin:3}}>Stock Market</a>|
                                                                    <a href="#" style={{margin:3}}>Apple</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div className="card-body">
                                                            <p>
                                                                {" "}
                                                                For me, getting my business website made was a
                                                                lot of tech wizardry things. Thankfully i get an
                                                                ad on Facebook ragarding commence website. I get
                                                                connected with BBB team. They made my stunning
                                                                website live in just 3 days. With the increase
                                                                demand of online customers. I had to take my
                                                                business online. BBB Team guided me at each step
                                                                and enabled me to centralise my work and have
                                                                control on all aspect of my online business.{" "}
                                                            </p>
                                                            <hr />
                                                            <svg
